...
def show_about():
    ...
    st.markdown("See full source code on my Github Repository at [**nchn471/tiki-recommender-etl-pipeline**](https://github.com/nchn471/tiki-recommender-etl-pipeline):")
